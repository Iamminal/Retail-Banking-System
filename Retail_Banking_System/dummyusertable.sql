...
drop table user1
create table user1(username varchar(50),password varchar(50),usertype varchar(50))
insert into user1 values('biswaa001','biswaA001','Cashier','Biswa Aich','What is your birth place','durgapur','bisaw.aich@abcbank.com')
alter table user1 add(name varchar(50))
alter table user1 add(email varchar(100))
alter table user1 add(securityquestion varchar(200))
alter table user1 add(answer varchar(50))
